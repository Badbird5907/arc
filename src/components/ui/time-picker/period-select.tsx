...
import { type Period, display12HourValue, setDateByType } from "@/components/ui/time-picker/utils";
    ...
    return (
        <div className="flex h-10 items-center">
            <Select value={period} onValueChange={(value: Period) => handleValueChange(value)}>
                <SelectTrigger ref={ref} className="w-[65px] h-full focus:bg-accent focus:text-accent-foreground justify-center" onKeyDown={handleKeyDown} showIcon={false}>
                    <SelectValue />
                </SelectTrigger>
                <SelectContent>
