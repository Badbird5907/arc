...
export function setMinutes(date: Date | null, value: string) {
...
export function setSeconds(date: Date | null, value: string) {
  if (!date) return new Date();
...
export function setHours(date: Date | null, value: string) {
  if (!date) return new Date();
...
export function set12Hours(date: Date | null, value: string, period: Period) {
  if (!date) return new Date();
